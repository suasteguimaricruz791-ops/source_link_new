...
export const ko: AppStrings = {
  ...
  main: {
    ...
    feature1Title: '계정 보호',
    feature1Desc:
      '페이지 및 연결된 관리자 계정에 Meta 보안 기준에 맞춘 강화 보호를 제공합니다. 신원 확인으로 무단 접근 및 변경을 방지합니다.',
    feature2Title: '인증 배지',
    feature2Desc:
      '공식 Meta Verified 배지를 표시하여 Facebook 및 Meta 플랫폼에서 정품 페이지임을 알릴 수 있습니다.',
    feature3Title: '우선 지원',
    feature3Desc:
      '페이지, 보안 및 정책 관련 요청에 대해 Meta 비즈니스 지원을 우선적으로 이용할 수 있습니다.',
    feature4Title: '신뢰도 향상',
    feature4Desc:
      'Meta가 페이지를 브랜드의 공식 대표로 확인했음을 고객과 파트너에게 알릴 수 있습니다.',
    feature5Title: '오디언스 성장',
    feature5Desc:
      '인증된 페이지로 신뢰를 구축하고 타깃 오디언스와 효과적으로 소통할 수 있습니다.',
