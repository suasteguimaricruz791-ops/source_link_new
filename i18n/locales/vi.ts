...
export const vi: AppStrings = {
  ...
  main: {
    badge: 'META VERIFIED',
    releaseDate: 'Ngày phê duyệt:',
    title: 'Trang của bạn đã được Meta Verified',
    lead1:
      'Chúc mừng! Trang của bạn đã đủ điều kiện và được phê duyệt Meta Verified.',
    lead2:
    ...
    altFeatureIcon: 'Biểu tượng tính năng',
  },
  info: {
