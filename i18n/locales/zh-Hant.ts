...
export const zhHant: AppStrings = {
  ...
  main: {
    ...
    feature1Title: '帳號保護',
    feature1Desc:
      '為粉絲專頁及關聯管理員帳號提供強化保護，監控符合 Meta 安全標準。身分驗證有助防止未經授權的存取與變更。',
    feature2Title: '認證徽章',
    feature2Desc:
      '展示官方 Meta Verified 徽章，協助使用者在 Facebook 及 Meta 各平台識別您的專頁真實性。',
    feature3Title: '優先支援',
    feature3Desc:
      '優先使用 Meta 企業支援，處理專頁、安全及政策相關請求。',
    feature4Title: '提升信任',
    feature4Desc:
      '向客戶與夥伴表明 Meta 已確認您的專頁為品牌的官方代表。',
    feature5Title: '受眾成長',
    feature5Desc:
      '透過已驗證的專頁建立信任，並與目標受眾有效互動。',
    feature6Title: '變現機會',
    feature6Desc:
